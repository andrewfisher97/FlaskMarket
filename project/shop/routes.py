...
def shop_page():
    ...
    if request.method == "POST":
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"Congratulations! You sold {s_item_object.name} and received ${s_item_object.price}.", category="success")
            else:
    ...
    if request.method == "GET":
        ...
        return render_template('shop.html', items=items, purchase_form=purchase_form, owned_items=owned_items, selling_form=selling_form)
